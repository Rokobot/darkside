...
class CustomSearchableDropDown extends StatefulWidget {
  ...
  @override
  CustomSearchableDropDownState createState() => CustomSearchableDropDownState();
}
    ...
    return Visibility(
      ...
      child: SizedBox(
        ...
        child: Padding(
          ...
          child: TextField(
            controller: searchC,
            style: widget.textStyle ?? context.t.displayMedium?.copyWith(color: AppColors.blackColor),
            decoration: InputDecoration(
              fillColor: Colors.white,
              hintStyle: widget.hintStyle ?? context.t.displayMedium?.copyWith(color: AppColors.textFieldHintColor),
              filled: true,
